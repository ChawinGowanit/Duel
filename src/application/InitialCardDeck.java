...
public class InitialCardDeck {
	...
	public InitialCardDeck() {
		...
		this.startingCard
				.add(new MilitaryCard("Ambriel", new Cost(0, 0, 1, 0, 0, 0), 1, new ChainSymbols("Laternora")));
		this.startingCard.add(new MilitaryCard("Ifrit", new Cost(1, 0, 0, 0, 0, 0), 1, new ChainSymbols("Rhine Lab")));
		this.startingCard
				.add(new MilitaryCard("EarthSpirit", new Cost(0, 0, 0, 0, 0, 2), 1, new ChainSymbols("Leithanien")));
		...
		this.startingCard
				.add(new RawMaterialCard("Matterhorn", new Cost(0, 0, 0, 0, 0, 1), new Cost(1, 0, 0, 0, 0, 0)));
		this.startingCard.add(new RawMaterialCard("Shirayuki", new Cost(), new Cost(0, 1, 0, 0, 0, 0)));
		this.startingCard
				.add(new RawMaterialCard("FlameBringer", new Cost(0, 0, 0, 0, 0, 1), new Cost(0, 1, 0, 0, 0, 0)));
		this.startingCard
				.add(new RawMaterialCard("Out-country", new Cost(0, 0, 0, 0, 0, 1), new Cost(0, 0, 0, 0, 1, 0)));
		this.startingCard.add(new RawMaterialCard("Forest", new Cost(0, 0, 0, 0, 0, 1), new Cost(0, 0, 0, 1, 0, 0)));
		this.startingCard.add(new TradingCard("Motoimaru", new Cost(0, 0, 0, 0, 0, 3), new ChainSymbols(), new Cost(),
				new Cost(0, 1, 0, 0, 0, 0), 0));
		this.startingCard.add(new TradingCard("Shaw", new Cost(0, 0, 0, 0, 0, 3), new ChainSymbols(), new Cost(),
		...
		this.midGameCard.add(new PointCard("Texas", new Cost(2, 0, 0, 0, 0, 0), 4,
				new ChainSymbols("Rhodes Island", "Penguin Logistic")));
		this.midGameCard
				.add(new PointCard("Zima", new Cost(0, 0, 1, 1, 0, 0), 4, new ChainSymbols("Ursus", "Victoria")));
		...
		this.midGameCard.add(new TradingCard("Manticore", new Cost(1, 0, 0, 0, 0, 3), new ChainSymbols(),
				new Cost(0, 0, 0, 1, 1, 0), new Cost(), 0));
		this.midGameCard.add(new TradingCard("Executor", new Cost(0, 0, 0, 1, 1, 2), new ChainSymbols(),
				new Cost(1, 1, 1, 0, 0, 0), new Cost(), 0));
		this.midGameCard.add(new TradingCard("Cliffheart", new Cost(0, 0, 0, 0, 0, 4), new ChainSymbols(), new Cost(),
				new Cost(0, 0, 0, 1, 1, 0), 0));
		this.midGameCard.add(new TradingCard("Pramanix", new Cost(), new ChainSymbols("Kjerag"),
				new Cost(0, 0, 0, 0, 0, 6), new Cost(), 0));
		// cardAgeThree
		...
		this.lateGameCard
				.add(new MilitaryCard("Eyjafjalla", new Cost(1, 2, 0, 1, 0, 0), 2, new ChainSymbols("Leithanien")));
