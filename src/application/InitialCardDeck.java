...
public class InitialCardDeck {
	...
	public InitialCardDeck() {
		...
		this.startingCard.add(new MilitaryCard("Volcano Boss",new Cost(0,0,0,0,0,0),1,"")) ;
		this.startingCard.add(new MilitaryCard("Volcano Boss",new Cost(0,0,0,0,0,0),1,"")) ;
		...
		this.startingCard.add(new PointCard("Lappland",new Cost(0,0,0,0,0,0),3,"Rhodes Island"));
		this.startingCard.add(new PointCard("Istina",new Cost(0,0,0,0,0,0),3,"Ursus"));
		this.startingCard.add(new PointCard("Meteor",new Cost(0,1,0,0,0,0),3,"Kazimierz")) ;
		this.startingCard.add(new RawMaterialCard("Cuora",new Cost(0,0,0,0,0,0),new Cost(0,0,1,0,0,0))) ;
		this.startingCard.add(new RawMaterialCard("Frostleaf",new Cost(0,0,0,0,0,1),new Cost(0,0,1,0,0,0))) ;
		this.startingCard.add(new RawMaterialCard("Courior",new Cost(0,0,0,0,0,0),new Cost(1,0,0,0,0,0))) ;
		this.startingCard.add(new RawMaterialCard("Matterhorn",new Cost(0,0,0,0,0,1),new Cost(1,0,0,0,0,0))) ;
		this.startingCard.add(new RawMaterialCard("Shirayuki",new Cost(0,0,0,0,0,0),new Cost(0,1,0,0,0,0))) ;
		...
		this.startingCard.add(new TradingCard("Motoimaru",new Cost(0,0,0,0,0,3),"",new Cost(0,0,0,0,0,0),"decreaseBipolarNanoFlakeCost",0)) ;
		this.startingCard.add(new TradingCard("Shaw",new Cost(0,0,0,0,0,3),"",new Cost(0,0,0,0,0,0),"decreaseD32SteelCost",0)) ;
		this.startingCard.add(new TradingCard("Dur-Nar",new Cost(0,0,0,0,0,3),"",new Cost(0,0,0,0,0,0),"decreasePolymerizationPreparationCost",0)) ;
		this.startingCard.add(new TradingCard("Rope",new Cost(0,0,0,0,0,0),"Rim Bilition",new Cost(0,0,0,0,0,4),"",0)) ;
		//cardAgeTwo
